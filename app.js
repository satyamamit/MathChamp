...
(function () {
    ...
    const REWARDS = {
        activities: [
            ...
            { id: 'bike_ride', emoji: '🚲', name: 'Bike Ride Adventure', desc: 'Go on a bike ride to the park!', cost: 120, tier: 'common' },
            { id: 'baking_day', emoji: '🧁', name: 'Baking Day', desc: 'Bake cookies or a cake together!', cost: 200, tier: 'rare' },
            { id: 'board_game', emoji: '🎲', name: 'Board Game Night', desc: 'Pick the game for family game night!', cost: 100, tier: 'common' },
            { id: 'craft_time', emoji: '✂️', name: 'Craft Project', desc: 'Pick a fun craft to make!', cost: 150, tier: 'common' },
            { id: 'science_exp', emoji: '🧪', name: 'Science Experiment', desc: 'Do a cool science experiment at home!', cost: 200, tier: 'rare' },
        ],
        privileges: [
            ...
            { id: 'breakfast_bed', emoji: '🥞', name: 'Breakfast in Bed', desc: 'Get breakfast served in bed!', cost: 150, tier: 'common' },
            { id: 'no_veggies', emoji: '🍩', name: 'No Veggies Dinner', desc: 'One dinner with no vegetables!', cost: 120, tier: 'common' },
            { id: 'music_choice', emoji: '🎵', name: 'DJ for a Day', desc: 'Pick the music in the car all day!', cost: 100, tier: 'common' },
            { id: 'homework_break', emoji: '📚', name: 'Homework-Free Evening', desc: 'One evening off from extra homework!', cost: 200, tier: 'rare' },
        ...
        toys: [
            ...
            { id: 'book_choice', emoji: '📖', name: 'Book of Your Choice', desc: 'Pick any book from the bookstore!', cost: 250, tier: 'rare' },
        ...
        legendary: [
            ...
            { id: 'water_park', emoji: '🌊', name: 'Water Park Day', desc: 'A full day at the water park!', cost: 3000, tier: 'legendary' },
            { id: 'camping_trip', emoji: '⛺', name: 'Camping Adventure', desc: 'A family camping trip!', cost: 5000, tier: 'legendary' },
        ]
    };
